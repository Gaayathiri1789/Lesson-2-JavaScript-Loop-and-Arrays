...
// PUT YOUR CODE HERE
function repeat(numOfTimes) {
  for (let i = 1; i <= numOfTimes; i++) {
    console.log("Q1: Hello World!", i);
  }
}
repeat(7);
// ---------- QUESTION 2 ----------
...
const wordWithoutVowel = noVowels("adventurous");
console.log("Q3: ", wordWithoutVowel);
...
function vowelCount(word) {
  let count = 0;
  for (let i = 0; i < word.length; i++) {
    if ("aeiouAEIOU".includes(word.charAt(i))) {
      count++;
    }
  }
  return count;
}
const numOfVowels = vowelCount("I love to code");
console.log("Q4: ", numOfVowels);
// ---------- QUESTION 5 ----------
...
function getElementAt(arrayParam, intParam) {
  return arrayParam.length > intParam ? arrayParam[intParam] : null;
}
console.log("Q7: ", getElementAt(full, 2));
console.log("Q7: ", getElementAt(full, 7));
// ---------- QUESTION 8 ----------
...
let part = ["dream", 19, "code", "hello", 180];
function compareArrays(full, arrayToCompare) {
  if (full.length !== arrayToCompare.length) {
    return false;
  }
  for (let i = 0; i < full.length; i++) {
    if (full[i] !== arrayToCompare[i]) {
      return false;
    }
  }
  return true;
...
// PUT YOUR CODE HERE
function findEvens(originalArray) {
  let newArray = [];
...
function findOdds(originalArray) {
  let newArray = [];
  for (let i = 0; i < originalArray.length; i++) {
    if (originalArray[i] % 2 !== 0) {
      newArray.push(originalArray[i]);
...
//Using Filter method
function findEvensUsingFilter(originalArray) {
  return originalArray.filter((num) => num % 2 === 0);
}
function findOddsUsingFilter(originalArray) {
  return originalArray.filter((num) => num % 2 !== 0);
}
console.log("Q11 evens: ", findEvens([10, 2, 3, 19, 7, 6, 93]));
console.log("Q11 odds: ", findOdds([10, 2, 3, 19, 7, 6, 93]));
console.log(
  "Q11 evens using filter: ",
  findEvensUsingFilter([10, 2, 3, 19, 7, 6, 93])
);
console.log(
  "Q11 odds using filter: ",
  findOddsUsingFilter([10, 2, 3, 19, 7, 6, 93])
);
// ---------- QUESTION 12 ----------
...
console.log("Q12: ", makeSquares([2, 5, 8]));
//Using Map method
function makeSquaresUsingMap(array) {
  let newArray = [];
  array.map((num) => newArray.push(num * num));

  return newArray;
}
console.log("Q12: ", makeSquaresUsingMap([2, 5, 99, 8]));
// EXAMPLE OUTPUT:
// ---------- QUESTION 13 ----------
